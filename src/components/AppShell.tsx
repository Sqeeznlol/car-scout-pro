...
import { Bell, LayoutGrid, Archive, Settings, Car, Sparkles, LogOut, Calculator } from "lucide-react";
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active
                    ? "bg-sidebar-accent text-sidebar-accent-foreground font-medium nav-active-stripe"
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    active ? "text-primary nav-active-top" : "text-muted-foreground",
                  )}
                >
